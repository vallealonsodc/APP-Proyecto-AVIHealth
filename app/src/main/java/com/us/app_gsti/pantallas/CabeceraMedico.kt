...
import com.us.app_gsti.pantallas.medico.CrearPacienteActivity

open class CabeceraMedico : AppCompatActivity() {
    ...
    fun showMenuMedico(v: View) {
        val popup = PopupMenu(this, v)
        val inflater: MenuInflater = popup.menuInflater
        inflater.inflate(R.menu.menu_medico, popup.menu)
        popup.setOnMenuItemClickListener { menuItem ->
            when(menuItem.itemId) {
                R.id.menu_crear_paciente -> {
                    // Acción para "Crear paciente"
