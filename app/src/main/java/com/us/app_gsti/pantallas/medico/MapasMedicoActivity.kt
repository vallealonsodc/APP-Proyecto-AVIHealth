...
class MapasMedicoActivity : CabeceraMedico(), OnMapReadyCallback, GoogleMap.OnMyLocationClickListener {
    ...
    companion object {
        const val REQUEST_CODE_LOCATION = 5
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.us.app_gsti.R.layout.activity_mapas_medico)
        ...
        val mapasButton = findViewById<Button>(R.id.btn_mapa)
    ...
    override fun onRequestPermissionsResult(
        ...
        when(requestCode){
            ...
            MapasPacienteActivity.REQUEST_CODE_LOCATION -> if(grantResults.isNotEmpty() && grantResults[0]== PackageManager.PERMISSION_GRANTED){
                //codigo autogenerado para map.isMyLocationEnabled
                if (ActivityCompat.checkSelfPermission(
                        this,
                        Manifest.permission.ACCESS_FINE_LOCATION
                    ) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
